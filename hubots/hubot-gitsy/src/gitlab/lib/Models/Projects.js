(function() {
  ...
  Projects = (function(superClass) {
    ...
    function Projects() {
      ...
      this.getSnippet = bind(this.getSnippet, this);
      this.listSnippets = bind(this.listSnippets, this);
    ...
    Projects.prototype.listSnippets = function(params, fn) {
      ...
      this.debug("Projects::listSnippets()");
      return this.get("projects/" + params.id + "/snippets", (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    Projects.prototype.getSnippet = function(params, fn) {
      if (params == null) {
        params = {};
      }
      if (fn == null) {
      ...
      this.debug("Projects::listSnippets()");
      return this.get("projects/" + params.id + "/snippets/" + params.sid + "/raw", (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
