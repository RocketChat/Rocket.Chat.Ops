...
class Projects extends BaseModel
  ...
  listSnippets: (params={}, fn=null) =>
    @debug "Projects::listSnippets()"
    @get "projects/#{params.id}/snippets", (data) => fn data if fn

  getSnippet: (params={}, fn=null) =>
    @debug "Projects::listSnippets()"
    @get "projects/#{params.id}/snippets/#{params.sid}/raw", (data) => fn data if fn
